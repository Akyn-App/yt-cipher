...
export class PoTokenManager {
  ...
  /**
   * Adapts the native fetch API to the shape bgutils-js expects.
   * The library's FetchFunction type expects a fetch-like interface,
   * so we use Deno's built-in fetch directly — no axios needed.
   */
